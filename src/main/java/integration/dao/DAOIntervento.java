...
public class DAOIntervento extends HQSQLDAO<Intervento> {
    ...
    private static final String GET_ALL_QUERY = "SELECT ID, Citta, CAP, Indirizzo, Data, Ora, PazienteID, InfermiereID FROM Intervento ORDER BY ABS( DATEDIFF( Data, NOW() ) ), Ora DESC";
